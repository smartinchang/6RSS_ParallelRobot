...
if (check>0):
    ...
    print("asb1 =",asb1*180/np.pi)
    print("asb2 =",asb2*180/np.pi)
    print("asb3 =",asb3*180/np.pi)
    print("asb4 =",asb4*180/np.pi)
    print("asb5 =",asb5*180/np.pi)
    print("asb6 =",asb6*180/np.pi)
    ...
    if (check>0):
        ...
        # Vẽ các chuỗi động
        ax.plot3D([0,zl[0]],[0,zl[1]],[0,zl[2]])
