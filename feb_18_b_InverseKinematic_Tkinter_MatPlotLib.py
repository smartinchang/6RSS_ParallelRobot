...
def checkin(pb0,ax,ay,az):
    global a1,a2,a3,a4,a5,a6,asp1,asp2,asp3,asp4,asp5,asp6,asb1,asb2,asb3,asb4,asb5,asb6,c1,c2,c3,c4,c5,c6,pb1,pb2,pb3,pb4,pb5,pb6
...
def clicked():
    global pp1,pp2,pp3,pp4,pp5,pp6,bb1,bb2,bb3,bb4,bb5,bb6,ab1,ab2,ab3,ab4,ab5,ab6,lsa
    ...
    if (checkin(pb0,ax,ay,az)==1):
        ...
        txt_active_angle_1_value.delete(0,END)
        txt_active_angle_1_value.insert(0,round(a1*180/np.pi,2))
        txt_active_angle_2_value.delete(0,END)
        txt_active_angle_2_value.insert(0,round(a2*180/np.pi,2))
        txt_active_angle_3_value.delete(0,END)
        txt_active_angle_3_value.insert(0,round(a3*180/np.pi,2))
        txt_active_angle_4_value.delete(0,END)
        txt_active_angle_4_value.insert(0,round(a4*180/np.pi,2))
        txt_active_angle_5_value.delete(0,END)
        txt_active_angle_5_value.insert(0,round(a5*180/np.pi,2))
        txt_active_angle_6_value.delete(0,END)
        txt_active_angle_6_value.insert(0,round(a6*180/np.pi,2))
        txt_passive_angle_1_platform_value.delete(0,END)
        txt_passive_angle_1_platform_value.insert(0,round(asp1*180/np.pi,2))
        txt_passive_angle_1_base_value.delete(0,END)
        txt_passive_angle_1_base_value.insert(0,round(asb1*180/np.pi,2))
        txt_passive_angle_2_platform_value.delete(0,END)
        txt_passive_angle_2_platform_value.insert(0,round(asp2*180/np.pi,2))
        txt_passive_angle_2_base_value.delete(0,END)
        txt_passive_angle_2_base_value.insert(0,round(asb2*180/np.pi,2))
        txt_passive_angle_3_platform_value.delete(0,END)
        txt_passive_angle_3_platform_value.insert(0,round(asp3*180/np.pi,2))
        txt_passive_angle_3_base_value.delete(0,END)
        txt_passive_angle_3_base_value.insert(0,round(asb3*180/np.pi,2))
        txt_passive_angle_4_platform_value.delete(0,END)
        txt_passive_angle_4_platform_value.insert(0,round(asp4*180/np.pi,2))
        txt_passive_angle_4_base_value.delete(0,END)
        txt_passive_angle_4_base_value.insert(0,round(asb4*180/np.pi,2))
        txt_passive_angle_5_platform_value.delete(0,END)
        txt_passive_angle_5_platform_value.insert(0,round(asp5*180/np.pi,2))
        txt_passive_angle_5_base_value.delete(0,END)
        txt_passive_angle_5_base_value.insert(0,round(asb5*180/np.pi,2))
        txt_passive_angle_6_platform_value.delete(0,END)
        txt_passive_angle_6_platform_value.insert(0,round(asp6*180/np.pi,2))
        txt_passive_angle_6_base_value.delete(0,END)
        txt_passive_angle_6_base_value.insert(0,round(asb6*180/np.pi,2))
        ...
        chart_type.get_tk_widget().place(x=170,y=20,width=865,height=460)
...
txt_passive_angle_1_platform_value=Entry(window,width=7,justify=CENTER)
txt_passive_angle_1_platform_value.place(x=1080,y=200)
txt_passive_angle_1_base_value=Entry(window,width=7,justify=CENTER)
...
txt_passive_angle_2_platform_value=Entry(window,width=7,justify=CENTER)
txt_passive_angle_2_platform_value.place(x=1080,y=220)
txt_passive_angle_2_base_value=Entry(window,width=7,justify=CENTER)
...
txt_passive_angle_3_platform_value=Entry(window,width=7,justify=CENTER)
txt_passive_angle_3_platform_value.place(x=1080,y=240)
txt_passive_angle_3_base_value=Entry(window,width=7,justify=CENTER)
...
txt_passive_angle_4_platform_value=Entry(window,width=7,justify=CENTER)
txt_passive_angle_4_platform_value.place(x=1080,y=260)
txt_passive_angle_4_base_value=Entry(window,width=7,justify=CENTER)
...
txt_passive_angle_5_platform_value=Entry(window,width=7,justify=CENTER)
txt_passive_angle_5_platform_value.place(x=1080,y=280)
txt_passive_angle_5_base_value=Entry(window,width=7,justify=CENTER)
...
txt_passive_angle_6_platform_value=Entry(window,width=7,justify=CENTER)
txt_passive_angle_6_platform_value.place(x=1080,y=300)
txt_passive_angle_6_base_value=Entry(window,width=7,justify=CENTER)
